...
public interface ProdutoRepository extends JpaRepository<Produto, Integer>{
	...
	/**
	 * Versao do metodo acima, porem, usando a sintaxe do spring data
	 * @param categorias
	 * @param pageRequest
	 * @return
	 */
	Page<Produto> findDistinctByNomeContainingAndCategoriasId(List<Categoria> categorias, Pageable pageRequest);
